...
preprint (2026).\
[arXiv](https://arxiv.org/abs/2605.06369) &nbsp;&nbsp; <input type="checkbox" id="abstract-1" class="abstract-toggle" /><label for="abstract-1" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
preprint (2025).\
[arXiv](https://arxiv.org/abs/2508.12806) &nbsp;&nbsp; <input type="checkbox" id="abstract-2" class="abstract-toggle" /><label for="abstract-2" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
[Journal](https://doi.org/10.1007/s10623-024-01471-1) &nbsp;&nbsp; [arXiv](https://arxiv.org/abs/2311.08288) &nbsp;&nbsp; <input type="checkbox" id="abstract-3" class="abstract-toggle" /><label for="abstract-3" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
[Journal](https://escholarship.org/uc/item/83g3149p#main) &nbsp;&nbsp; [arXiv](https://arxiv.org/abs/2203.06709v2) &nbsp;&nbsp; <input type="checkbox" id="abstract-4" class="abstract-toggle" /><label for="abstract-4" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
[Journal](https://doi.org/10.1002/jcd.21903) &nbsp;&nbsp; [arXiv](https://arxiv.org/abs/2109.01586v2) &nbsp;&nbsp; <input type="checkbox" id="abstract-5" class="abstract-toggle" /><label for="abstract-5" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
[Report](https://doi.org/10.4230/DagRep.13.4.40) &nbsp;&nbsp; <input type="checkbox" id="abstract-6" class="abstract-toggle" /><label for="abstract-6" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
[PDF](https://digital.ub.uni-paderborn.de/doi/10.17619/UNIPB/1-1672) &nbsp;&nbsp; <input type="checkbox" id="abstract-7" class="abstract-toggle" /><label for="abstract-7" class="abstract-link">Abstract</label><span class="abstract-content"><span class="date">
...
*Packings and Steiner systems in polar spaces*\
  <span class="date">10th Slovenian Conference on Graph Theory, Kranjska Gora, Slovenia, Jun 2023.</span>

*Packings and Steiner systems in polar spaces*\
  <span class="date">Colloquium on Combinatorics, Paderborn, Germany, Nov 2022.</span>

*The linear programming bounds in classical association schemes*\
  <span class="date">Finite Geometries---Sixth Irsee Conference, Irsee, Germany, Sept 2022.</span>\
  (Invitation-only conference)

*The linear programming bounds in classical association schemes*\
  <span class="date">Algebraic Coding Theory Summer School---ACT22, Zurich, Switzerland, July 2022.</span>
